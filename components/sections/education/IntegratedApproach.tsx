    ...
    >
      <div className="mt-10 lg:mt-0 space-y-6 text-lg leading-relaxed text-silver-400">
        <p>
          ...
          organizations are the methods it will teach, held to the same
          standard of practical usefulness.
        </p>
        <p>
          That integration is the discipline behind this work. Consulting
          grounds the knowledge in real operating conditions. Methodology
          gives it structure. Intellectual property preserves it.
          Education is being built to extend it to people and
          organizations — and what returns from teaching will sharpen the
          practice it came from.
        </p>
        <p>
