    ...
    >
      <div className="mt-10 lg:mt-0 space-y-6 text-lg leading-relaxed text-silver-400">
        <p>
          ...
          is meant for structured continuity where continued support is
        ...
        <p>
          Approved institutional knowledge will keep that support
          consistent, repeatable, and reviewable. Education &amp;
          Workforce Development is being built to reinforce what support
          alone cannot create — people who understand and operate their
          own systems. And technology may support coordination,
          documentation, visibility, and measurement within sustained
          operations, in the same subordinate role it plays everywhere
          else in the Company&apos;s work.
        </p>
        <p>
