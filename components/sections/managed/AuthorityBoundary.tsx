    ...
    >
      <div className="mt-10 lg:mt-0 space-y-6 text-lg leading-relaxed text-silver-400">
        <p>
          ...
          leaders and authorized decision-makers retain responsibility for
          organizational direction and every consequential decision.
          Huerta Group supports, coordinates, advises, implements,
          documents, reviews, and reinforces — it does not assume
          executive authority, board authority, legal accountability, or
          operational control that belongs to the organization.
        </p>
        <p>
