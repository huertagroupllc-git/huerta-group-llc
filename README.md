...
- **Navigation** links to the `/services`, `/methodology`, `/intellectual-property`, `/education`, `/about`, and `/contact` routes, with the header CTA also leading to `/contact`. No link points to a page that does not exist.
